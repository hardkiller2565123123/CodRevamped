...
// CodRevamped: shared ImGui code resolves DXGI from System32 directly.
// Do not depend on a client-specific proxy symbol; every game uses version.dll.
static HRESULT ImGui_ImplDX12_CreateSystemDXGIFactory1(REFIID riid, void** ppFactory)
{
...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    HRESULT hr = ImGui_ImplDX12_CreateSystemDXGIFactory1(IID_PPV_ARGS(&bd->pdxgiFactory));
    IM_ASSERT(hr == S_OK);
