...
#include "../../../../../../../shared/common/utils/image.hpp"
...
namespace splash
{
	namespace
	{
		...
		void show()
		{
			...
			wnd_class.hCursor = LoadCursor(nullptr, IDC_APPSTARTING);
			...
			if (RegisterClassA(&wnd_class))
			{
				...
				if (image)
				{
					window = CreateWindowExA(WS_EX_APPWINDOW, "Black Ops 4 Splash Screen", "CodRevamped T8",
						WS_POPUP | WS_SYSMENU,
