...
namespace hashes
{
	...
	public:
		...
		{
			enabled = utils::json_config::ReadBoolean("gsc", "hashes", true);
			...
			// load default files
			std::filesystem::path default_file_name_str = storage_paths::Path("custom_data\\t8\\strings.txt");
			...
			std::filesystem::path default_file_name_common = storage_paths::Path("custom_data\\t8\\hashes.csv");
