...
#include "../../../../../../../shared/common/utils/thread.hpp"
#include "../../../../../../../shared/common/utils/compression.hpp"
#include "../../../../../../../shared/common/exception/minidump.hpp"
...
namespace blackbox
{
	namespace
	{
		...
		void display_error_dialog()
		{
			...
			MessageBoxA(nullptr, error_str.data(), "CodRevamped T8 ERROR", MB_ICONERROR);
		...
		void reset_state()
		{
			if (is_recoverable())
			{
				...
				game::Com_Error(game::ERR_DROP, "Fatal error (0x%08X) at 0x%p (0x%p).\nA minidump has been written.\n\n"
				                "CodRevamped has tried to recover your game, but it might not run stable anymore.\n\n"
...
#undef EXCEPTION_CASE
		...
		void write_minidump(const LPEXCEPTION_POINTERS exceptioninfo)
		{
			...
			zip_file.write(crash_name, "CodRevamped T8 Crash Dump");
		}
