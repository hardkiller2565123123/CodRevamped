...
namespace unlockall
{
	namespace
	{
		int zm_loot_table[] =
		{
			...
			1000003,			// zm_bgb_in_plain_t8sight
	...
	public:
		...
		{
			utils::hook::jump(0x1438AE2F0_g, return_false); // patch LiveStats data source
			
			utils::hook::jump(0x1437F6ED0_g, liveinventory_getitemquantity); // grant every loot item

			utils::hook::jump(0x1406BB410_g, bg_unlockedgetchallengeunlockedforindex);
			utils::hook::jump(0x1406B5530_g, bg_unlockablesitemoptionlocked);
			utils::hook::jump(0x1406B34D0_g, bg_unlockablesisitemattachmentlocked);
			utils::hook::jump(0x1406B3290_g, bg_unlockablesisattachmentslotlocked);
			utils::hook::jump(0x1406AC010_g, bg_unlockablesemblemorbackinglockedbychallenge);
			utils::hook::jump(0x144184D20_g, bg_emblemisentitlementbackgroundgranted);
			utils::hook::jump(0x1406B3AA0_g, bg_unlockablesisitemlocked);
			utils::hook::jump(0x1406ae060_g, bg_unlockablesgetcustomclasscount);
		}
	};
}
