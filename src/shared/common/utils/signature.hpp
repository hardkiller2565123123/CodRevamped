...
utils::hook::signature::signature_result operator"" _iw8sig(const char* str, size_t len);

utils::hook::signature::signature_result operator"" _t8sig(const char* str, size_t len);
