...
#if defined(CODREVAMPED_MW169_LOCAL_HOOK)
#include "../../../clients/mw2019/game/mw169/hook.h"
namespace utils::hook
{
    inline void* install(void* target, void* replacement)
    {
        return ::hook::install(target, replacement);
    }
}
#else
#include "signature.hpp"

#include "../../../../third_party/bo4/asmjit/src/asmjit/core/jitruntime.h"
#include "../../../../third_party/bo4/asmjit/src/asmjit/x86/x86assembler.h"
...
namespace utils::hook
{
	...
	// Shared one-shot MinHook helper used by game-specific modules.
	// Returns the original trampoline on success, or nullptr on failure.
...
#endif // CODREVAMPED_MW169_LOCAL_HOOK
